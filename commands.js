...
use jaskis
//test
db //successfully displayed "jaskis" as current database

// 2. Create a collection called bounties
db.createCollection('bounties')
//test
show collections //successfully displayed "bounties" as list of collections in jaskis
...
//test
db.bounties.find() //successfully displayed the above data as list of documents in bounties collection
...
//BONUS
//Create Scavenger collection and insert data
...
//Queries
db.scavengers.find({joined: {$gte: new Date('2011-12-11')}})
